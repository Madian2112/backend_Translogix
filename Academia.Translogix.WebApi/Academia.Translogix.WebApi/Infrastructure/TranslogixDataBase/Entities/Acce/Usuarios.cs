...
namespace Academia.Translogix.WebApi.Infrastructure.TranslogixDataBase.Entities.Acce
{
    ...
    public class Usuarios
    {
        ...
        public ICollection<EstadosCiviles> EstadosCivilesCreacion { get; set; } = new List<EstadosCiviles>();
        public ICollection<EstadosCiviles> EstadosCivilesModificacion { get; set; } = new List<EstadosCiviles>();
        ...
        public ICollection<ServiciosTransporte> ServiciosTransporteCreacion { get; set; } = new List<ServiciosTransporte>();
        public ICollection<ServiciosTransporte> ServiciosTransporteModifiacion { get; set; } = new List<ServiciosTransporte>();
        public ICollection<ServiciosTransporteTransportistas> ServiciosTransporteTransportistasCreacion { get; set; } = new List<ServiciosTransporteTransportistas>();
        public ICollection<ServiciosTransporteTransportistas> ServiciosTransporteTransportistasModifiacion { get; set; } = new List<ServiciosTransporteTransportistas>();
        ...
        public ICollection<SucursalesColaboradores> SucursalesColaboradoresCreacion { get; set; } = new List<SucursalesColaboradores>();
        public ICollection<SucursalesColaboradores> SucursalesColaboradoresModifiacion { get; set; } = new List<SucursalesColaboradores>();
        ...
        public ICollection<ViajesDetalles> ViajesDetallesCreacion { get; set; } = new List<ViajesDetalles>();
        public ICollection<ViajesDetalles> ViajesDetallesModifiacion { get; set; } = new List<ViajesDetalles>();
