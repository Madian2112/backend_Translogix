...
{
    public class ServiciosTransporteTransportistasMap : IEntityTypeConfiguration<ServiciosTransporteTransportistas>
    {
        public void Configure(EntityTypeBuilder<ServiciosTransporteTransportistas> builder)
        {
