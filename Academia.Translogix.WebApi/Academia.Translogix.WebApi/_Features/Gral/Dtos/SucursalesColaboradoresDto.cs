...
namespace Academia.Translogix.WebApi._Features.Gral.Dtos
{
    ...
    public class SucursalesColaboradoresInsertar
    {
        [JsonIgnore]
        public decimal distancia_empleado_sucursal_km { get; set; } = 1;
        [Required]
        public int colaborador_id { get; set; }
        [Required]
        public int sucursal_id { get; set; }
    ...
    {
        public List<SucursalesColaboradoresInsertar> SucursalesColaboradores { get; set; } = new List<SucursalesColaboradoresInsertar>();
    }
