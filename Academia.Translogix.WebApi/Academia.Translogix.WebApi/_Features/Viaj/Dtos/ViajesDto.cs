...
namespace Academia.Translogix.WebApi._Features.Viaj.Dtos
{
    public class ViajesDto
    {
        ...
        public SucursalesDto sucursal { get; set; } = new SucursalesDto();
        public PersonasDto transportista { get; set; } = new PersonasDto();
    }
    public class ViajesModeloInsertarDto
    {
        ...
        public Coordinate Origen { get; set; } = new Coordinate();
        public List<Transportista> transportista { get; set; } = new List<Transportista>();
    ...
    {
        public double[] Ubicaciones { get; set; } = null!;
        public double[] Transportistas { get; set; } = null!;
